...
public:
    ...
    METHOD_LIST_BEGIN
    ADD_METHOD_TO(AgentController::list, "/api/agent", Get, "AuthFilter");
    ADD_METHOD_TO(AgentController::create, "/api/agent", Post, "AuthFilter");
    ADD_METHOD_TO(AgentController::options, "/api/agent/options", Get, "AuthFilter");
    ADD_METHOD_TO(AgentController::events, "/api/agent/{id}/events", Get, "AuthFilter");
    ADD_METHOD_TO(AgentController::update, "/api/agent/{id}", Put, "AuthFilter");
    ADD_METHOD_TO(AgentController::resync, "/api/agent/{id}/resync", Post, "AuthFilter");
    ADD_METHOD_TO(AgentController::updateNetworkConfig, "/api/agent/{id}/network-config", Put, "AuthFilter");
    ADD_METHOD_TO(AgentController::remove, "/api/agent/{id}", Delete, "AuthFilter");
    // Agent Endpoint routes
    ADD_METHOD_TO(AgentController::listEndpoints, "/api/agent/{id}/endpoints", Get, "AuthFilter");
    ADD_METHOD_TO(AgentController::createEndpoint, "/api/agent/{id}/endpoints", Post, "AuthFilter");
    ADD_METHOD_TO(AgentController::updateEndpoint, "/api/agent/endpoints/{id}", Put, "AuthFilter");
    ADD_METHOD_TO(AgentController::removeEndpoint, "/api/agent/endpoints/{id}", Delete, "AuthFilter");
    METHOD_LIST_END
