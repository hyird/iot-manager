...
```text
03 00 00 19 02 F0 80 32 01 00 00 00 00 00 08 00 00 F0 00 00 01 00 01 03 C0
```
...
```text
32 01 00 00 00 00 00 08 00 00 F0 00 00 01 00 01 03 C0
```
...
```text
03 00 00 1B 02 F0 80 32 03 00 00 00 00 00 08 00 00 00 00 F0 00 00 01 00 01 03 C0
```
