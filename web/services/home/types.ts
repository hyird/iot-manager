...
export interface MonitorData {
  ...
  modbus?: {
    ...
    exceptions: number;
    errorRate: number;
    registryDtuCount?: number;
    registryDeviceCount?: number;
    discoveryCapableDtuCount?: number;
    sessionCount?: number;
    boundSessionCount?: number;
    probingSessionCount?: number;
    unknownSessionCount?: number;
    discoveryRequestedSessionCount?: number;
    inflightSessionCount?: number;
    queuedJobCount?: number;
    onlineRouteCount?: number;
    legacyMappingsCleanedLastReload?: number;
    legacyMappingsCleanedTotal?: number;
  };
  sl651?: {
    framesParsed: number;
    crcErrors: number;
