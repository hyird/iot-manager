      ...
      <div className="flex flex-col flex-1 gap-3">
        {hasGroupSections
          ? sections.map((section) => (
              <section key={section.key} className="rounded-md border border-slate-100 bg-slate-50/60 px-2.5 py-2">
                <div className="mb-2 flex items-center gap-2">
                  <span className="rounded-full bg-white px-2 py-0.5 text-[12px] font-semibold text-slate-500 shadow-sm">
                    {section.label}
                  </span>
