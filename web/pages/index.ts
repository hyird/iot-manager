...
registerPage({
  ...
  name: "开放接入",
  module: "IOT管理",
  description: "AccessKey 和 Webhook 的开放接口管理",
  loader: () => import("./open-access/OpenAccess"),
  permissions: [
    { code: "iot:open-access:query", name: "查询开放接入", action: "query" },
    { code: "iot:open-access:add", name: "新增开放接入", action: "add" },
    { code: "iot:open-access:edit", name: "编辑开放接入", action: "edit" },
    { code: "iot:open-access:delete", name: "删除开放接入", action: "delete" },
  ],
});
