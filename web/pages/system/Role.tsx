...
const permModalButtonsStyle = { marginBottom: 16 };
...
const emptyTreeStyle = { textAlign: "center" as const, color: "#999", padding: 40 };
  ...
  return (
    ...
    >
      ...
      <Modal
        ...
        width={600}
      >
        <div style={permModalButtonsStyle}>
          <Space>
        ...
        <div style={treeContainerStyle}>
          {treeData.length > 0 ? (
            ...
            <div style={emptyTreeStyle}>暂无菜单数据</div>
          )}
        </div>
      </Modal>
    </PageContainer>
